      ...
      <header className="sticky top-0 z-30 border-b border-border bg-bg-card/80 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
            ...
            {/* Sites - icon on mobile, text on desktop */}
            <Link href="/sites" className="p-1.5 sm:p-0 text-text-secondary hover:text-text-primary transition-colors" title="Sites">
              <svg className="sm:hidden" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                <path d="M1 2.5A1.5 1.5 0 012.5 1h3A1.5 1.5 0 017 2.5v3A1.5 1.5 0 015.5 7h-3A1.5 1.5 0 011 5.5v-3zm8 0A1.5 1.5 0 0110.5 1h3A1.5 1.5 0 0115 2.5v3A1.5 1.5 0 0113.5 7h-3A1.5 1.5 0 019 5.5v-3zm-8 8A1.5 1.5 0 012.5 9h3A1.5 1.5 0 017 10.5v3A1.5 1.5 0 015.5 15h-3A1.5 1.5 0 011 13.5v-3zm8 0A1.5 1.5 0 0110.5 9h3a1.5 1.5 0 011.5 1.5v3a1.5 1.5 0 01-1.5 1.5h-3A1.5 1.5 0 019 13.5v-3z" />
              </svg>
              <span className="hidden sm:inline text-sm">Sites</span>
            </Link>

            {/* Sign out - icon on mobile, text on desktop */}
            <button onClick={signOut} className="p-1.5 sm:p-0 text-text-secondary hover:text-text-primary transition-colors" title="Sign out">
              <svg className="sm:hidden" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
