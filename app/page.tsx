      ...
      <section className="relative bg-dot-grid pt-24 pb-20 sm:pt-32 sm:pb-28 px-6 overflow-hidden">
        <div className="max-w-[1100px] mx-auto text-center">
          ...
          <div className="animate-fade-up animate-delay-200 flex flex-col sm:flex-row items-center justify-center gap-3">
            <CTAButton
              href="#demo"
              trackLabel="hero-demo"
              className="bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 px-7 py-3 rounded-lg text-sm font-semibold hover:opacity-90 transition"
            >
              See live demo &darr;
            </CTAButton>
            <CTAButton
              href="/signup"
              trackLabel="hero-signup"
              className="border border-neutral-300 dark:border-neutral-700 px-7 py-3 rounded-lg text-sm font-semibold hover:bg-neutral-50 dark:hover:bg-neutral-900 transition"
            >
              Start free
            </CTAButton>
          </div>
